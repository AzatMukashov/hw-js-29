    ...
    <div className="card mb-3 p-4">
      <div className="row justify-content-between">
        ...
        <div className="col-6">
          ...
          <p className="card-text">Price: {user.price} som</p>
        </div>
      </div>
    </div>
  );
